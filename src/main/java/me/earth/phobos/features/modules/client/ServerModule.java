...
public class ServerModule
    ...
    public Setting<String> serverIP = this.register(new Setting<String>("ServerIP", "jballs.org"));
    ...
    public ServerModule() {
        super("PingBypass", "Manages Neverdies internal Server", Module.Category.CLIENT, false, false, true);
        instance = this;
    }
